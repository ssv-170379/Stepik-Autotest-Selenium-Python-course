...
@pytest.fixture # этого не было в примере, просто чтобы не ругалось на отсутствующую фикстуру browser. На результат не влияет.
def browser():
	pass
...
def main():
	system(f'pytest -v -m "smoke and not beta_users" "{__file__}"')
